...
class datumGen: public rclcpp::Node
{
    ...
    private:
        ...
        rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr sub_debug_odom;

        //Publishers
        rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr pub_vel;
        rclcpp::Publisher<sensor_msgs::msg::Imu>::SharedPtr pub_global_imu;
        rclcpp::Publisher<geometry_msgs::msg::Point>::SharedPtr pub_debug_or;
        rclcpp::Publisher<geometry_msgs::msg::Point>::SharedPtr pub_debug_hunter_or;
        ...
        void odomDebugCallback(const nav_msgs::msg::Odometry::SharedPtr msg);
        void send_datum();
