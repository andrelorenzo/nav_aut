...
\textbf{figura \ref{fig:esquema_localizacion}}, esta instancia tendrá las mismas entradas que el otro ekf pero con el añadido de la posición del GPS 
proporcionada mediante el mensaje de odometría proveniente de la transformación del nodo navsat transform y por otro lado este filtro publicará 
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Round Robin}, este nodo funciona en oposición a \textit{Pipeline} donde ''llamará'' en bucle a todos los nodos de izquierda a derecha hasta que alguno de ellos devuelva \textit{Success}, donde el también devolverá \textins*{Success} sin importar el resto de nodos ''hijo''.
    \end{itemize}
\end{itemize}
...
que daba solución al problema de manera estable, este algoritmo funciona siguiendo \textit{objetivos} virtuales, 
