...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Round Robin}, este nodo funciona en opisición a \textit{Pipeline} donde ''llamará'' en bucle a todos los nodos de izquierda a derecha hasta que alguno de ellos devuelva \textit{Success}, donde el también devolverá \textins*{Success} sin importar el resto de nodos ''hijo''.
    \end{itemize}
\end{itemize}
